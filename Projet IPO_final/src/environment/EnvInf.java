...
public class EnvInf implements IEnvironment {
    ...
    public void update() {
         ...
         */
        if (game.getFrog1Direction() == Direction.up || game.getFrog2Direction() == Direction.up) {
        ...
        else if (game.getFrog1Direction() == Direction.down || game.getFrog2Direction() == Direction.down) {
            if (game.getFrog2Dist() > 0 && game.getFrog2Dist() > 0) {
